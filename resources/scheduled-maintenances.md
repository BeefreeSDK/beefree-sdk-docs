...
1. Ensure your implementation of Beefree SDK takes advantage of the [auto-save feature](../getting-started/readme/installation/configuration-parameters/) or [onChange callback](../getting-started/tracking-message-changes.md), so that the message is frequently auto-saved and no (or minimal) work is lost.
