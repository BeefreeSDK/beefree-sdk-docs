...
<table><thead><tr><th width="135.58984375">Code</th><th>Name</th><th>Description</th></tr></thead><tbody><tr><td>3100</td><td>fspBeGenericError</td><td>Unhandled server-side failure while accessing the backend file system.</td></tr><tr><td>3200</td><td>fspResourceNotFound</td><td>The file or folder does not exist.</td></tr><tr><td>3300</td><td>fspPermissionDenied</td><td>The operation is not permitted on that path.</td></tr><tr><td>3400</td><td>fspResourceAlreadyPresent</td><td>A resource with that name already exists and the conflict strategy did not resolve it.</td></tr><tr><td>3401</td><td>fspResourceAlreadyPresentNoDialog</td><td>A resource with that name already exists. Unlike 3400, the conflict is resolved without prompting the user with the overwrite dialog.</td></tr><tr><td>3410</td><td>fspFileTooBig</td><td>The file is larger than the maximum upload size allowed for the application.</td></tr><tr><td>3420</td><td>fspFileExtensionMissing</td><td>The filename has no extension and one could not be inferred from the file type.</td></tr><tr><td>3430</td><td>fspFileTypeNotAllowed</td><td>The file type is <a href="../../server-side-configurations/server-side-options/privacy-and-security.md#custom-limitations-on-the-file-manager">not permitted</a> for the application, or the file failed the security scan.</td></tr><tr><td>3450</td><td>fspFileNotUploaded</td><td>The file could not be retrieved from the source URL.</td></tr><tr><td>3500</td><td>fspRequestError</td><td>The request was malformed — a missing header, an unknown conflict strategy, or an invalid search query.</td></tr><tr><td>3600</td><td>fspUserError</td><td>The requested custom storage type is not supported. Only S3 is implemented for custom buckets.</td></tr><tr><td>3620</td><td>fspMultipleShareNotAllowed</td><td>A linked storage points at another linked storage, which is not supported.</td></tr><tr><td>3621</td><td>fspFeatureRequiresFspx</td><td>The application is on the legacy File System Provider and the feature requires the current one.</td></tr><tr><td>3622</td><td>fspMoveNotAllowed</td><td>Move is not available for this storage type.</td></tr><tr><td>3650</td><td>fspWrongCredentials</td><td>Wrong username or password.</td></tr><tr><td>3701</td><td>fspFileDownloadFailed</td><td>Upload by URL: the file could not be downloaded, or could not be stored afterwards.</td></tr><tr><td>3702</td><td>fspFileStoreFailed</td><td>Upload by body: no file was present in the request, or storing it failed.</td></tr><tr><td>3750</td><td>fspInvalidImportUrl</td><td>An invalid path, a missing or malformed header, an invalid conflict_strategy, or an invalid upload URL.</td></tr></tbody></table>
