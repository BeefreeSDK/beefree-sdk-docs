...
1. [About roles and permissions](broken-reference)
2. [Types of roles](broken-reference)
3. [Locking a row](broken-reference)
4. [Rows vs content blocks](broken-reference)
5. [Creating and editing user roles](broken-reference)
6. [How to use the Role Hash parameter](broken-reference)
7. [Combination of user roles and permissions](broken-reference)
8. [User roles & display conditions](broken-reference)
...
* Using [Display Conditions](https://docs.beefree.io/display-conditions/)
...
For more details on creating and editing user roles and their permissions, jump to [Creating and editing user roles](broken-reference). First, let’s see how the user experience changes in the builder.
...
If you use [_Display Conditions_](https://docs.beefree.io/display-conditions/) in your builder application, then you can use additional user roles to control the access users have to creating and editing _Display Conditions_. [Learn more](https://docs.beefree.io/display-conditions/#display-conditions-and-user-roles-permissions).
