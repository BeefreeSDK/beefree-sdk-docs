...
Visit [Workspaces](../getting-started/readme/installation/configuration-parameters/workspaces.md) to learn more about what workspaces are and the additional workspaces you can use for AMP content.
