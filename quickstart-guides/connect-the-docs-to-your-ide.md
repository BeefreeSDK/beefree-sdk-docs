---
description: >-
  Learn how to connect the Beefree docs to your IDE or favorite tools for
...
{% hint style="warning" %}
**Important:** Are you looking for our MCP server that supports AI-generated email creation? Visit the [Beefree SDK MCP Server technical documentation](../mcp-server/getting-started.md), which explains how you can use our Beefree SDK MCP to create powerful email creation and editing experiences for your end users. Stay on this page if you'd like to configure the Docs MCP in your IDE for AI-assisted developer workflows.&#x20;
{% endhint %}
...
1. In your workspace, create `.vscode/mcp.json` (or configure globally via _MCP: Open User Configuration_).
2. Add the server:
